...
c mmga
     ...
     .          CDC_SCA(ICORE-NN:ICORE+NN)
      ...
      DO 2000   I = ICORE-NN,ICORE+NN
        CDC_SCA(I)= LOG(CDC(I)) - 2.D0 * LOG(R(I))
 2000 CONTINUE
 ...
 2016 CONTINUE
      ...
      CDCP = 0.D0
      DO 2001 IN = IN1,IN2
        CDCP = CDCP + DR_K(IN) * CDC_SCA(ICORE+IN)
 2001 CONTINUE
      CDCP = CDCP / DR
 ...
 2002 CONTINUE
      ...
      DO 2010 IN = IN1,IN2
        ...
        DDCDC = DDCDC + DDR_K(IN) * CDC_SCA(ICORE+IN)
 2010 CONTINUE
      ...
      AC = CDC_SCA(ICORE) - BC*R(ICORE)**2 - CC*R(ICORE)**4
