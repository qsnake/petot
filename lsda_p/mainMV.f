...
*************************************************
     ...
     & fvr_in(2),fvr_out(2),f_tmp,fxatom_out,f_xatom
...
ccccccccccc
       ...
       write(22,308) nkpt,nrot,num_mov
       write(22,*) "*********************"
...
*********************************************************
     ...
     &  kpt_dens,nkpt,ispin_dens,islda,iw_i,iw_f,mx 
       ...
       call dens_out(AL,workr_n,iw_i,iw_f,fdens_out,kpt_dens)
...
*************** first, along the force direction, move a trial step dt
     ...
     &  dt,istop_line,ave_dx,AL,imov_at,convergE,
     &  message,dt_fact_nextlinemin)
********* input: mov, line_step; 
...
****************************************************************
         ...
         write(22,994) dt,ave_dx,force_max
         write(22,*) "****************************************"
         call system_flush(22)
         write(6,*) "**** within atom_mov_step:", mov
         write(6,*) "****  trial line_min_step:",line_step 
         write(6,994) dt,ave_dx,force_max
         endif

994      format("  dt= ",E10.4,",  ave_dx=",E10.4,",  force_max=",E10.4)
****************************************************************
****************************************************************
1000    continue
...
****************************************************************
       ...
       if(dabs(dt/dt_trial-1).gt.0.001d0) then
       call interpolation()
       endif    
****************************************************************
...
998      format(" ****  ave_dx= ", E9.3, ",   max_force= ",E9.3)
